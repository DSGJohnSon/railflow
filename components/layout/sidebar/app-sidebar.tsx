      ...
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              className="data-[slot=sidebar-menu-button]:p-1.5! data-[slot=sidebar-menu-button]:pr-2!"
            >
              <Link href="/" className="w-full max-w-2/3 h-full">
                <Image src="/logo/logo_line.svg" alt="RailFlow" className="object-contain" width={500} height={200} />
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
